...
void hello_message(){
	puts("There is a DBAPP");
	puts("what do you want to do in the App");
}
...
void menu(){
	...
	puts("DBAPP Menu");
	puts("----------------------------");
	puts("1.show the items in the App");
	puts("2.add a new item");
	puts("3.change the item in the App");
	puts("4.remove the item in the App");
	puts("5.exit");
	puts("----------------------------");
	printf("Your choice:");
}
